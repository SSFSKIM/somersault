...
CC-to-SDK/probes/probes/103b..105-*.ts       # the three spike files (see de-rot item 5)
...
**Files:**
- Create: `probes/probes/103b-streaminput-steer.ts`, `probes/probes/104-readfile.ts`, `probes/probes/105-reload-plugins-skills.ts` (reloads share a file — same shape)

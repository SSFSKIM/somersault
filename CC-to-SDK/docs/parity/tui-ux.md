...
> **2026-08-13 (post-fullscreen wave)**; each recount block below carries its own date, and older ones are
...
| Category | Parity (start) | Parity (pre-C5) | Parity (pre-F0, post–sprint-W3) | Parity (post-F2) | Parity (post-F3) | Parity (post-F4) | Parity (post-F5) | Parity (post-F6) | Parity (post-Wave T) | Parity (post-Wave C) | Parity (post-Wave 2 delta) | Parity (now, post-fullscreen wave) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|

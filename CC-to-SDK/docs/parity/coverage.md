...
| External `sessionStore` (S3/Redis/Postgres seam) | ✅ **W3.3**: Redis reference adapter + conformance suite + mirror_error surfacing; cross-host resume live-proven |

...
const OWNED: [string, string, unknown][] = [
  ...
  ["bash-decision-decorator", "subsystem/bash-executor", bashCompoundSafety.decorateBashAskDecision],
  ["bash-too-complex-rules", "subsystem/bash-executor", bashCompoundSafety.checkBashTooComplexRules],
  ["bash-too-complex-sandbox", "subsystem/bash-executor", bashCompoundSafety.checkBashTooComplexSandbox],
  ["bash-invalid-semantics-rules", "subsystem/bash-executor", bashCompoundSafety.checkBashInvalidSemanticsRules],
  ["bash-sandbox-auto-allow", "subsystem/bash-executor", bashCompoundSafety.checkBashSandboxAutoAllow],
  ["bash-exact-permission", "subsystem/bash-executor", bashCompoundSafety.checkBashExactPermission],
  ["bash-cd-git-sequence", "subsystem/bash-executor", bashCompoundSafety.checkBashCdGitSequence],
  ["bash-path-safety", "subsystem/bash-executor", bashCompoundSafety.checkBashPathSafety],
  ["bash-dangerous-removal", "subsystem/bash-executor", bashCompoundSafety.checkBashDangerousRemoval],
  ["bash-leading-directory", "subsystem/bash-executor", bashCompoundSafety.resolveBashLeadingDirectoryChange],
  ["bash-cd-git-ast-sequence", "subsystem/bash-executor", bashCompoundSafety.checkBashCdGitAstSequence],
  ["bash-git-structure-analysis", "subsystem/bash-executor", bashCompoundSafety.hasUnsafeBashGitStructureFromAnalysis],
  ["bash-git-structure-command", "subsystem/bash-executor", bashCompoundSafety.hasUnsafeBashGitStructureFromCommand],
  ["bash-direct-command", "subsystem/bash-executor", bashCompoundSafety.checkBashDirectCommand],
  ["bash-subcommand-permission", "subsystem/bash-executor", bashCompoundSafety.checkBashSubcommandPermission],
  ["bash-prefix-exact-rules", "subsystem/bash-executor", bashCompoundSafety.checkBashPrefixAndExactRules],
  ["bash-nested-dangerous-removal", "subsystem/bash-executor", bashCompoundSafety.checkNestedDangerousRemoval],
  ["bash-sandbox-rules", "subsystem/bash-executor", bashCompoundSafety.checkSandboxRules],
  ["bash-cd-target", "subsystem/bash-executor", bashCompoundSafety.parseCdTarget],
  ["bash-same-directory-cd", "subsystem/bash-executor", bashCompoundSafety.checkSameDirectoryCd],
  ["bash-output-redirections", "subsystem/bash-executor", bashCompoundSafety.checkOutputRedirections],
  ["bash-ast-path-command", "subsystem/bash-executor", bashCompoundSafety.checkAstPathCommand],
  ["bash-text-path-command", "subsystem/bash-executor", bashCompoundSafety.checkTextPathCommand],
  ["bash-path-command-checker", "subsystem/bash-executor", bashCompoundSafety.createPathCommandChecker],
  ["bash-path-command", "subsystem/bash-executor", bashCompoundSafety.checkPathCommand],
];

...
// SEVEN rows since W-C T12 added `Prompt suggestions` below W-C T7's `Show turn duration`; that new row
// is the list's last one.
...
pinsListNavigation(
  ...
  ["Theme", "Model", "Output style", "Default permission mode", "Thinking mode", "Show turn duration", "Prompt suggestions"],
);

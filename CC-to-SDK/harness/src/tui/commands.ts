...
export const COMMANDS: CommandRow[] = [
  ...
  // T-MENU task 3: /cost, /status, /usage, /stats now OPEN the Settings dialog (spec A1) instead of
  // printing a text dump — summaries updated to say so, `/config`'s own phrasing.
  { name: "cost", summary: "open the Settings dialog (Usage tab) — session cost + token usage" },
  { name: "status", summary: "open the Settings dialog (Status tab) — model · mode · context · session" },
  ...
  { name: "usage", summary: "open the Settings dialog (Usage tab) — plan usage / rate-limit windows" },
  ...
  { name: "stats", summary: "open the Settings dialog (Stats tab) — conversation + token/cost statistics" },
